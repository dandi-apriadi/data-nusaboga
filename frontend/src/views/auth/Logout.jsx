    ...
    <>
      <div className="mt-16 flex h-full w-full items-center justify-center">
        <div className="text-center">
          {isError ? (
            <p className="text-xs sm:text-sm md:text-base text-red-500">{message}</p>
          ) : (
            <p className="text-xs sm:text-sm md:text-base text-navy-700 dark:text-white">Logging out...</p>
          )}
        </div>
      </div>
      <Footer />
