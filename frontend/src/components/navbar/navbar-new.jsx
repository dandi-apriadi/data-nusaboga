  ...
  return (
    <nav className="sticky top-4 z-60 flex flex-row flex-wrap items-center justify-between rounded-2xl bg-gradient-to-r from-white/80 via-white/70 to-white/60 dark:from-navy-900/80 dark:via-navy-800/70 dark:to-navy-700/60 p-4 backdrop-blur-xl lg:flex-nowrap w-full border border-white/30 dark:border-white/10 shadow-2xl shadow-indigo-500/10 dark:shadow-black/20 transition-all duration-300 hover:shadow-indigo-500/20">
      ...
      <div className="flex items-center space-x-3">
        {/* Mobile Menu Toggle */}
        <button
          className="relative z-60 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 border border-indigo-100 dark:border-indigo-800/30 hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 xl:hidden"
        ...
        <Dropdown
          ...
          children={
            <div className="flex w-[320px] md:w-[360px] flex-col gap-3 rounded-2xl bg-gradient-to-br from-white/95 via-white/90 to-white/80 dark:from-navy-800/95 dark:via-navy-800/90 dark:to-navy-700/80 p-5 shadow-2xl backdrop-blur-xl border border-white/20 dark:border-navy-600/30">
              ...
              <div className="flex w-full items-center rounded-xl bg-gradient-to-r from-green-50/80 to-emerald-50/80 dark:from-green-900/30 dark:to-emerald-900/30 p-4 border border-green-100 dark:border-green-800/30 hover:shadow-lg hover:shadow-green-500/10 transition-all cursor-pointer group">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 text-xl text-white shadow-lg group-hover:shadow-green-500/25 transition-all">
                ...
                <div className="ml-3 flex h-full w-full flex-col justify-center">
                  ...
                  <p className="mt-1 text-[11px] font-medium text-green-500">
                    30 menit yang lalu
                  </p>
                </div>
              </div>

              <button className="mt-2 w-full flex justify-center items-center py-3 text-sm font-medium text-blue-500 hover:text-blue-700 transition-colors border-t border-gray-100 dark:border-navy-700 pt-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/10">
        ...
        <Link
          to="/admin/default"
          className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/30 dark:to-blue-900/30 border border-indigo-100 dark:border-indigo-800/30 hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 group"
          title="Dashboard"
        >
          <RiDashboardLine className="h-5 w-5 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform" />
        </Link>

        {/* Enhanced Profile Dropdown */}
        <Dropdown
          button={
            <button className="flex h-10 w-10 items-center justify-center rounded-xl border-2 border-indigo-500 dark:border-indigo-400 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 ml-1">
          ...
          children={
            <div className="flex w-56 flex-col justify-start rounded-2xl bg-gradient-to-br from-white/95 via-white/90 to-white/80 dark:from-navy-800/95 dark:via-navy-800/90 dark:to-navy-700/80 backdrop-blur-xl shadow-2xl border border-white/20 dark:border-navy-600/30">
              {/* User Info */}
              <div className="p-4">
                <div className="flex items-center gap-2">
                  <p className="text-sm font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
              ...
              <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-200 dark:via-navy-700 to-transparent" />

              {/* Menu Items */}
              <div className="flex flex-col p-3">
                <Link
                  to="/admin/profile"
                  className="flex items-center rounded-xl px-3 py-2 text-sm text-gray-800 dark:text-white hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 dark:hover:from-indigo-900/20 dark:hover:to-purple-900/20 transition-all duration-300"
                >
                ...
                <Link
                  to="/admin/settings"
                  className="flex items-center rounded-xl px-3 py-2 mt-1 text-sm text-gray-800 dark:text-white hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 dark:hover:from-indigo-900/20 dark:hover:to-purple-900/20 transition-all duration-300"
                >
                  <span className="mr-2 text-gray-600 dark:text-gray-400">
                    <svg
                      width="16"
              ...
              <div className="p-3">
                <button
                  onClick={handleLogout}
                  disabled={isLoading}
                  className="flex items-center rounded-xl px-3 py-2 text-sm font-medium text-red-500 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 dark:hover:from-red-900/20 dark:hover:to-pink-900/20 transition-all duration-300 w-full disabled:opacity-50 disabled:cursor-not-allowed"
                >
