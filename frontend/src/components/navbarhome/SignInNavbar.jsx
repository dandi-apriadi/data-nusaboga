...
const SignInNavbar = () => {
  ...
  return (
    <>
      <nav className="fixed w-full z-50 transition-all duration-300 bg-gradient-to-r from-amber-500 via-yellow-400 to-green-600 shadow-lg border-b border-green-700 py-3"
      aria-label="Main navigation">
        <div className="max-w-7xl mx-auto px-6 py-2 transition-all duration-300">
          <div className="flex justify-between items-center">
            {/* Brand */}
            <div className="flex items-center">
              <Link to="/auth/homepage" className="flex items-center group">
                <div className="relative mr-3">
                  <div className="absolute inset-0 bg-amber-500/30 rounded-full scale-125 group-hover:scale-150 transition-all duration-300 opacity-60"></div>
                  <img
                    src={logo}
                    alt="Logo"
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-gradient-to-r from-amber-500 via-yellow-400 to-green-600 border-t border-green-700 shadow-lg">
        <div className="grid grid-cols-6 h-16">
          ...
          >
            <div className="relative p-2">
              <div className="absolute inset-0 rounded-full bg-green-600/20 scale-0 group-hover:scale-100 transition-transform duration-200"></div>
              <FiPackage className="w-5 h-5 relative z-10" />
            </div>
